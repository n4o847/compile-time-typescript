...
- From TypeScript 4.7 RC
  - [`extends` Constraints on `infer` Type Variables](https://devblogs.microsoft.com/typescript/announcing-typescript-4-7-rc/#extends-constraints-on-infer-type-variables)
